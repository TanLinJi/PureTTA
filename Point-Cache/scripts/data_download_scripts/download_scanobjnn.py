...
API_URL = "https://hf-mirror.com/api/datasets/auniquesun/Point-Cache/tree/main/scanobjnn"
DOWNLOAD_BASE = "https://hf-mirror.com/datasets/auniquesun/Point-Cache/resolve/main/scanobjnn"

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(os.path.dirname(SCRIPT_DIR))
DATA_DIR = os.path.join(PROJECT_ROOT, "data")
SAVE_DIR = os.path.join(DATA_DIR, "scanobjnn")
PATH_PREFIX = "scanobjnn/"
...
def main():
    ...
    print(f"Download target directory: {SAVE_DIR}")
