...
# 1. 设置镜像站 API 路径，指向 modelnet_c 文件夹
API_URL = "https://hf-mirror.com/api/datasets/auniquesun/Point-PRC/tree/main/new-3ddg-benchmarks/xset/corruption/modelnet_c"
DOWNLOAD_BASE = "https://hf-mirror.com/datasets/auniquesun/Point-PRC/resolve/main/new-3ddg-benchmarks/xset/corruption/modelnet_c"

# 2. 准备存数据的目录（Point-Cache/data/modelnet_c）
