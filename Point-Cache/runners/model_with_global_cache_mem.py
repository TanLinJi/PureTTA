...
def main():
    ...
    if args.wandb:
        if args.lm3d == 'openshape':
            prefix = f"[memory]/{args.cache_type}_cache/{args.lm3d}-{args.oshape_version}" 
        elif args.lm3d == 'ulip':
            prefix = f"[memory]/{args.cache_type}_cache/{args.ulip_version}"
        else:
            prefix = f"[memory]/{args.cache_type}_cache/{args.lm3d}"
