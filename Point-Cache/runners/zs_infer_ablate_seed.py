...
def main(args):
    ...
    if args.wandb:
        if args.lm3d == 'openshape':
            prefix = f"[zs_infer-ablate-seed{args.seed}]/global_feat/{args.lm3d}-{args.oshape_version}"
        elif args.lm3d == 'ulip':
            prefix = f"[zs_infer-ablate-seed{args.seed}]/global_feat/{args.ulip_version}"
        else:
            prefix = f"[zs_infer-ablate-seed{args.seed}]/global_feat/{args.lm3d}"
