...
def main():
    ...
    if args.wandb:
        if args.lm3d == 'openshape':
            prefix = f"[ablation_{args.k_shot}shot_{args.n_cluster}cluster_{args.alpha}alpha_{args.beta}beta]/{args.cache_type}_cache/{args.lm3d}-{args.oshape_version}" 
        elif args.lm3d == 'ulip':
            prefix = f"[ablation_{args.k_shot}shot_{args.n_cluster}cluster_{args.alpha}alpha_{args.beta}beta]/{args.cache_type}_cache/{args.ulip_version}"
        else:
            prefix = f"[ablation_{args.k_shot}shot_{args.n_cluster}cluster_{args.alpha}alpha_{args.beta}beta]/{args.cache_type}_cache/{args.lm3d}"
